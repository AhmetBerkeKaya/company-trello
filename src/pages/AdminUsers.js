    ...
    return (
      <div className="max-w-7xl mx-auto py-6 px-4">
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Erişim Engellendi</h2>
          <p className="text-gray-600">Bu sayfayı görüntüleme yetkiniz bulunmuyor.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto py-6 px-4">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {users.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Sisteme giriş yapan kullanıcılar burada listelenecek.</p>
          </div>
        )}
      </div>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div>
            <h4 className="text-sm font-medium text-blue-800">Kullanıcı Yönetimi İpuçları</h4>
